...
Asymmetric multiprocessor reference SoC: an application core beside a real-time core.
...
Planned, not started. Work starts when a second kind of core exists in the library.
